					...
					<div
						...
						<div className="w-full max-w-md mt-12">
							<div className="p-8 bg-white/80 backdrop-blur rounded-lg shadow-md">
								<h2 className="mb-8 text-2xl font-bold text-center uppercase font-next-art">РЕГИСТРАЦИЯ</h2>
								...
								<Form action="" className="space-y-6">
									...
									<div className="grid grid-cols-2 gap-4">
										<Button
												...
												className={`h-12 text-2xl font-bold ${sex === "male" ? "bg-yellow-500 hover:bg-yellow-600" : ""}`}
												onClick={() => setSex("male")}
										>
											М
										</Button>
										<Button
												...
												className={`h-12 text-2xl font-bold ${sex === "female" ? "bg-yellow-500 hover:bg-yellow-600" : ""}`}
